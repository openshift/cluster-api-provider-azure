...
type Client interface {
	List(context.Context) (compute.ResourceSkusResultPage, error)
}
...
// List enumerates all values, automatically crossing page boundaries as required.
func (ac *AzureClient) List(ctx context.Context) (compute.ResourceSkusResultPage, error) {
	return ac.resourceSkus.List(ctx, "")
}
