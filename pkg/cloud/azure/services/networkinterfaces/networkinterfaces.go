...
func (s *Service) CreateOrUpdate(ctx context.Context, spec azure.Spec) error {
	...
	if to.Bool(s.Scope.MachineConfig.AcceleratedNetworking) {
		...
		klog.V(3).Infof("setting EnableAcceleratedNetworking to %v", to.Bool(s.Scope.MachineConfig.AcceleratedNetworking))
		nicProp.EnableAcceleratedNetworking = s.Scope.MachineConfig.AcceleratedNetworking
	}
