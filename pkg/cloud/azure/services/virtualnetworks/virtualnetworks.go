...
func (s *Service) Get(ctx context.Context, spec azure.Spec) (interface{}, error) {
	...
	vnet, err := s.Client.Get(ctx, s.Scope.NetworkResourceGroup, vnetSpec.Name, "")
...
func (s *Service) CreateOrUpdate(ctx context.Context, spec azure.Spec) error {
	...
	f, err := s.Client.CreateOrUpdate(ctx, s.Scope.NetworkResourceGroup, vnetSpec.Name,
...
func (s *Service) Delete(ctx context.Context, spec azure.Spec) error {
	...
	future, err := s.Client.Delete(ctx, s.Scope.NetworkResourceGroup, vnetSpec.Name)
	if err != nil && azure.ResourceNotFound(err) {
		// already deleted
		return nil
	}
	if err != nil {
		return errors.Wrapf(err, "failed to delete vnet %s in resource group %s", vnetSpec.Name, s.Scope.NetworkResourceGroup)
	}
